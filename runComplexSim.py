...
abcd = h.EdgeServer(25,[a,b,c,d])
efgh = h.EdgeServer(26,[e,f,g,h0])
ijkl = h.EdgeServer(27,[i,j,k,l])
mnop = h.EdgeServer(28,[m,n,o,p])
qrst = h.EdgeServer(29,[q,r,s,t])
uvwx = h.EdgeServer(30,[u,v,w,x])
CHS = h.CentralHeatingSys(31,[abcd,efgh,ijkl,mnop,qrst,uvwx])
